 ...
 */
public class MetadataServiceDelegation implements MetadataService, Disposable, MetadataServiceDelegationInterface {
    ...
    private boolean isAcceptableProtocol(String protocol, URL url) {
        return protocol == null || protocol.equals(url.getParameter(PROTOCOL_KEY)) || protocol.equals(url.getProtocol());
    }
