...
public class AbstractMethodBuilder<T extends AbstractMethodConfigInterface, B extends AbstractMethodBuilderInterface<T,B>> implements AbstractMethodBuilderInterface<T, B> {
