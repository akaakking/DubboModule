...
public class ReferenceConfigBase<T> implements ReferenceConfigBaseInterface<T> {
    ...
    public static Class<?> determineInterfaceClass(String generic, String interfaceName, ClassLoader classLoader) {
        Method method = instance.getClass().getMethod(String.class, String.class, ClassLoader.class);
