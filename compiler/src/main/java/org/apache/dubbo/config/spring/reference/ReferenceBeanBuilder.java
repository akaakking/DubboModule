...
public class ReferenceBeanBuilder implements ReferenceBeanBuilderInterface {
    ...
    public ReferenceBeanBuilderInterface setRegistries(List<? extends RegistryConfig> registries) {
        return instance.setRegistries(registries);
    }

    public ReferenceBeanBuilderInterface setMethods(List<? extends MethodConfig> methods) {
