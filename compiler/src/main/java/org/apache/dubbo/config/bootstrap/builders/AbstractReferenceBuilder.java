...
public class AbstractReferenceBuilder<T extends AbstractReferenceConfigInterface, B extends AbstractReferenceBuilderInterface<T,B>> implements AbstractReferenceBuilderInterface<T, B> {
