...
public class DefaultApplicationDeployer implements DefaultApplicationDeployerInterface {
    ...
    public static ApplicationDeployerInterface get(ScopeModelInterface moduleOrApplicationModel) {
        Method method = instance.getClass().getMethod(ScopeModelInterface.class);
