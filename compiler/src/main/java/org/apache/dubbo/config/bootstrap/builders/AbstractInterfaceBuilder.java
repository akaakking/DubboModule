...
public class AbstractInterfaceBuilder<T extends AbstractInterfaceConfigInterface, B extends AbstractInterfaceBuilderInterface<T,B>> implements AbstractInterfaceBuilderInterface<T, B> {
