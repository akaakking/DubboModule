...
public class ApplicationBuilder implements ApplicationBuilderInterface {
    ...
    public ApplicationBuilderInterface addRegistries(List<? extends RegistryConfig> registries) {
